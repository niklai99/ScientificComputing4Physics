# Docker Installation and Setup for Task 9
...
!!! info "Prerequisites"
    ...
    - Follow the Docker installation instructions in [Task 1](../task1/install_docker.md) before proceeding with Task 9.
...
2. Run the following command to build the Docker image:
    ...
    ```bash
    docker build -t sci-comp-task9 -f docker/Dockerfile.alma9 .
    ```

      1. `-t sci-comp-task9` tags the image with the name `sci-comp-task9`.
